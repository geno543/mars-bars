...
const materialsData: MaterialData[] = [
  {
    ...
    inputImagePath: new URL('../images/Air Pillow Film for Uline Air Cushion Machine.png', import.meta.url).href,
    ...
    outputImagePath: new URL('../images/Insulation blankets.png', import.meta.url).href,
    sustainability: 88,
  ...
  },
  {
    ...
    inputImagePath: new URL('../images/Aluminum Steam Table Pans - Full Size ( Structural Elements).png', import.meta.url).href,
    ...
    outputImagePath: new URL('../images/Reflective heat shields.png', import.meta.url).href,
    sustainability: 92,
  ...
  },
  {
    ...
    inputImagePath: new URL('../images/Anti-Static Bubble Bags.jpg', import.meta.url).href,
    ...
    outputImagePath: new URL('../images/Padded tool wraps.png', import.meta.url).href,
    sustainability: 75,
  ...
  },
  {
    ...
    inputImagePath: new URL('../images/Carbon Fiber Sheet & Epoxy Resin Kit ( structural elements).jpg', import.meta.url).href,
    ...
    outputImagePath: new URL('../images/Tool ahndles and repair patches.avif', import.meta.url).href,
    sustainability: 40,
  ...
  },
  {
    ...
    inputImagePath: new URL('../images/CEL Scientific Kynar Gas Sampling Gas.jpg', import.meta.url).href,
    ...
    outputImagePath: new URL('../images/Flexible containment bladders.png', import.meta.url).href,
    sustainability: 65,
  ...
  },
  {
    ...
    inputImagePath: new URL('../images/Clothing example ( Hanes men undershirt ) Fabrics.png', import.meta.url).href,
    outputProduct: 'Patch kits',
    outputDescription: 'Fabric reinforcements for clothing and equipment, extending their life.',
    outputImagePath: new URL('../images/Patch kits.png', import.meta.url).href,
    sustainability: 85,
  ...
  },
  {
    ...
    inputImagePath: new URL('../images/Glenroy White Ready Seal 225 Food Packaging.png', import.meta.url).href,
    outputProduct: 'Lightproof pouches',
    outputDescription: 'Protect samples and food from light exposure and contamination.',
    outputImagePath: new URL('../images/Lightproof pouches.png', import.meta.url).href,
    sustainability: 60,
  ...
  },
  {
    ...
    inputImagePath: new URL('../images/Magid NOM10 Nomex White Hood ( EVA Waste ).jpg', import.meta.url).href,
    ...
    outputImagePath: new URL('../images/Filter pre-cover for dusty air by Magid NOM10 Nomex White Hood.png', import.meta.url).href,
    sustainability: 78,
  ...
  },
  {
    ...
    inputImagePath: new URL('../images/Nitrile gloves.jpg', import.meta.url).href,
    ...
    outputImagePath: new URL('../images/Gaskets and seals by Nitrile gloves.png', import.meta.url).href,
    sustainability: 58,
  ...
  },
  {
    ...
    inputImagePath: new URL('../images/R&R Textile Wash Cloth (Fabrics).jpg', import.meta.url).href,
  ...
  },
  {
    ...
    outputImagePath: new URL('../images/Mars Rocknest Soil.avif', import.meta.url).href,
    sustainability: 80,
  ...
  },
  {
    ...
    inputImagePath: new URL('../images/Zotefoams Plastazote LD45FR.jpg', import.meta.url).href,
